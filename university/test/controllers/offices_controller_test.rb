...
class OfficesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create office" do
    assert_difference('Office.count') do
      post offices_url, params: { office: { building_name: @office.building_name, floor_number: @office.floor_number, room_number: @office.room_number } }
    end
  ...
  test "should update office" do
    patch office_url(@office), params: { office: { building_name: @office.building_name, floor_number: @office.floor_number, room_number: @office.room_number } }
